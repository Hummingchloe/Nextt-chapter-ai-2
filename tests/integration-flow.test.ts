...
const scenarios: Scenario[] = [
  ...
  {
    id: "finance-ops-class",
    label: "업무 자동화 클래스",
    promise: "반복 업무를 줄이고 싶은 직장인에게 엑셀·AI 자동화 첫 실습을 제공한다",
    answers: {
      current_thought: "is_it_valuable",
      current_state: "vague_ideas",
      korea_experience: "금융권에서 일했고, 숫자와 돈 이야기를 쉽게 설명하는 편이에요.",
      us_experience: "동료들이 엑셀과 AI로 반복 업무를 어떻게 줄일 수 있냐고 물어요.",
      often_asked: "보고서 정리와 자동화 흐름을 어떻게 시작하면 좋을지 자주 물어봐요.",
      good_at_unpaid: "복잡한 업무 흐름을 초보자 눈높이에 맞춰 쉽게 풀어줘요.",
      work_style: "small_group",
      energy_giving: "동료들이 직접 자동화해보고 시간이 줄었다고 할 때 에너지가 나요.",
      dont_want: "딱딱한 툴 기능 강의처럼 보이는 건 싫어요.",
  ...
  },
  {
    ...
    answers: {
      ...
      us_experience: "주변에서 다음 커리어로 뭘 다시 시작해야 할지 모르겠다는 이야기를 많이 들어요.",
